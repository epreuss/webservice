...
namespace WebApp.IPServiceRef {
    ...
    public interface GeoIPServiceSoap {
        ...
        WebApp.IPServiceRef.GeoIP GetGeoIP(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIP", ReplyAction="*")]
        System.Threading.Tasks.Task<WebApp.IPServiceRef.GeoIP> GetGeoIPAsync(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WebApp.IPServiceRef.GeoIP GetGeoIPContext();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        System.Threading.Tasks.Task<WebApp.IPServiceRef.GeoIP> GetGeoIPContextAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GeoIPServiceSoapChannel : WebApp.IPServiceRef.GeoIPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GeoIPServiceSoapClient : System.ServiceModel.ClientBase<WebApp.IPServiceRef.GeoIPServiceSoap>, WebApp.IPServiceRef.GeoIPServiceSoap {
        ...
        public WebApp.IPServiceRef.GeoIP GetGeoIP(string IPAddress) {
            return base.Channel.GetGeoIP(IPAddress);
        }
        
        public System.Threading.Tasks.Task<WebApp.IPServiceRef.GeoIP> GetGeoIPAsync(string IPAddress) {
            return base.Channel.GetGeoIPAsync(IPAddress);
        }
        
        public WebApp.IPServiceRef.GeoIP GetGeoIPContext() {
            return base.Channel.GetGeoIPContext();
        }
        
        public System.Threading.Tasks.Task<WebApp.IPServiceRef.GeoIP> GetGeoIPContextAsync() {
