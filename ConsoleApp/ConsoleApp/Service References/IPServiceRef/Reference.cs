...
namespace ConsoleApp.IPServiceRef {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.webservicex.net/", ConfigurationName="IPServiceRef.GeoIPServiceSoap")]
    public interface GeoIPServiceSoap {
        ...
        ConsoleApp.IPServiceRef.GeoIP GetGeoIP(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIP", ReplyAction="*")]
        System.Threading.Tasks.Task<ConsoleApp.IPServiceRef.GeoIP> GetGeoIPAsync(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ConsoleApp.IPServiceRef.GeoIP GetGeoIPContext();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        System.Threading.Tasks.Task<ConsoleApp.IPServiceRef.GeoIP> GetGeoIPContextAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GeoIPServiceSoapChannel : ConsoleApp.IPServiceRef.GeoIPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GeoIPServiceSoapClient : System.ServiceModel.ClientBase<ConsoleApp.IPServiceRef.GeoIPServiceSoap>, ConsoleApp.IPServiceRef.GeoIPServiceSoap {
        ...
        public ConsoleApp.IPServiceRef.GeoIP GetGeoIP(string IPAddress) {
            return base.Channel.GetGeoIP(IPAddress);
        }
        
        public System.Threading.Tasks.Task<ConsoleApp.IPServiceRef.GeoIP> GetGeoIPAsync(string IPAddress) {
            return base.Channel.GetGeoIPAsync(IPAddress);
        }
        
        public ConsoleApp.IPServiceRef.GeoIP GetGeoIPContext() {
            return base.Channel.GetGeoIPContext();
        }
        
        public System.Threading.Tasks.Task<ConsoleApp.IPServiceRef.GeoIP> GetGeoIPContextAsync() {
